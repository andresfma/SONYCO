...
@router.post("/register", response_model=UsuarioRead, summary="Registrar nuevo usuario")
def register_user(
...
@router.get("/{user_id}", response_model=UsuarioRead, summary="Obtener perfil de usuario actual")
def get_perfil_user(
    user_id=int,
    db: Session = Depends(get_session),
