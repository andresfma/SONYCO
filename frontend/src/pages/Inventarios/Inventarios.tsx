...
export default function Inventarios() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await api.get('/exportar/inventarios', {
      ...
      let filename = 'inventarios_export.xlsx'; // nombre por defecto
      ...
      console.error('Error al exportar inventarios:', err);
  ...
  const handleInventarioDetail = (inventario: Inventario) => {
    // Navegar a página de detalle del inventario
    navigate(`/inventarios/${inventario.id}`);
  };

  const handleInventarioEdit = (inventario: Inventario) => {
    // Navegar a página de edición del inventario
    navigate(`/inventarios/${inventario.id}/editar`);
  };
  ...
  return (
    < div className="p-4" >
      ...
      <div className="flex justify-between items-center mb-8 pb-2">
        ...
        <div>
          ...
          <p className="text-cl_font_sec mt-1">
            Crea, edita y administra cada detalle de tus inventarios.
          </p>
        </div>
        ...
        <div className="space-x-4">
          ...
          <button
            onClick={() => navigate('/inventarios/crear')}
      ...
      <InventariosTable
        onInventarioDetail={handleInventarioDetail}
        onInventarioEdit={handleInventarioEdit}
        showActions={{
          detail: true,
          edit: true,
          toggleActive: true,
