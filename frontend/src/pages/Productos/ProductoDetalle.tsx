...
export default function ProductoDetalle() {
  ...
  // Configuración de campos para mostrar detalles del producto
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const response = await api.get(`/exportar/movimientos/producto/${id}`, {
      ...
      let filename = 'producto_movimientos_export.xlsx'; // nombre por defecto
